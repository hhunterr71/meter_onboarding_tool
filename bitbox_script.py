...
def add_missing_fields(df: pd.DataFrame, asset_name: str, generalType: str, typeName: str, pre_add: Optional[List[str]] = None) -> pd.DataFrame:
    missing_fields: List[str] = list(pre_add) if pre_add else []
...
def main() -> None:
    ...
    df = add_missing_fields(df, asset_name, generalType, typeName, pre_add=pre_add_fields)
